...
% output: micro_F is micro average
function [micro_F]=micro_average(testPredictions,testResponse)
...
microP=TP_avg/(TP_avg+FP_avg);
microR=TP_avg/(TP_avg+FN_avg);
micro_F=2*microP*microR/(microP+microR);
end