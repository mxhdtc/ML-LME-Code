...
p + geom_point() + geom_smooth(method = "lm")+labs(x = 'Estimations', y = 'Sample Observations')+theme(title = element_text(size = 20), axis.title.x = element_text(size = 20), axis.title.y = element_text(size = 20))+ scale_x_continuous(limits = c(0,210),expand = c(0,0)) + scale_y_continuous(limits = c(0,210),expand = c(0,0))
